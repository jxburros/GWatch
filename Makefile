...
.PHONY: build build-ncruces build-cgo windows docker rsrc agent agent-all test test-race test-postgres test-mysql cover fmt fmt-check vet tidy-check web-check web-test ci run keygen sign verify-release mcp-build mcp-test mcp-fmt
